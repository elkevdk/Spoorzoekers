...
def main():
    ...
    # ScoreDistribution(20000, Score_Optimizer, all_connections, 'output/score_distribution_so.png', 'Score Distribution Optimizer, Holland', 7, all_connections, 120)
    # ScoreDistribution(20000, Greedy, all_connections, 'output/score_distribution_greedy.png', 'Score Distribution Greedy, Holland', 7, all_connections, 120)
    #
